                    ...
                    <div className={style.aboutContent}>
                        <div className={style.contentLeftColumn}>
                            ...
                            <div className={style.aboutText}>
                                <p>
                                    Hello, my name is <strong>Roman</strong>, I'm a front-end developer using React, TypeScript,
                                    Redux and more. My main direction is Single Page Application. I want to find a company and
                                    a team in which I can grow in this direction. You can also see my CV.
                                </p>
                            </div>
                            <div className={style.aboutButtonBlock}>
                                <button onClick={()=> getFile('http://localhost:3010/RomanKachuraCV','RomanKachuraCV')} className={style.aboutButton}>DOWNLOAD CV</button>
                                <Link
                        ...
                        <div className={style.contentRightColumn}>
                            <div className={style.aboutImageBlock}>
                                <img src={photo} className={style.aboutImage} title='Roman Kachura' alt='Roman Kachura'/>
                            </div>
                        </div>
                    </div>
                </Fade>
